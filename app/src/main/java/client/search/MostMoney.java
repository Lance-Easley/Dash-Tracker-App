...
public class MostMoney extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText(R.string.most_money_earned);

        HashMap<String, String> data = Variables.dbUtils.getEarningsByRestaurant(Variables.dbUtils.getRestaurantNames());
        ArrayList<String[]> sortedData = Methods.getSortedHashMapArray(data);

        SearchResultsAdapter resultAdapter = new SearchResultsAdapter(this, sortedData, true, false);
