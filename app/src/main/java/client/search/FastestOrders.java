...
public class FastestOrders extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText(R.string.fastest_restaurants);

        HashMap<String, String> data = Variables.dbUtils.getOrderCompleteTimesByRestaurant();
        ArrayList<String[]> sortedData = Methods.getSortedTimeHashMapArray(data);

        SearchResultsAdapter resultAdapter = new SearchResultsAdapter(this, sortedData, false, false);
