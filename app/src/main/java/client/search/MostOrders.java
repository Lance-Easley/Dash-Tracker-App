...
public class MostOrders extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        title.setText(R.string.most_orders);

        HashMap<String, String> data = Variables.dbUtils.getNumberOfOrdersByRestaurant(Variables.dbUtils.getRestaurantNames());
